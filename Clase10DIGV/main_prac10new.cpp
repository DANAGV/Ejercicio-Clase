...
//*************		Visual Studio 2017				******//
//*************		Fecha entrega: 19 Octubre 2018			******//
//*****Moviento del carro con limites en el trayecto
//***** Teclas de manipulacion
//***** Con la barra espaciadora se reinica el moviento
//***** p el carro ira hacia delante
//***** P el carro ira hacia atras
//************************************************************//
//************************************************************//
...
void animacion()
{
	fig3.text_izq-= 0.001;
	fig3.text_der-= 0.001;
	if (movKit <= -128.5) //se limitan los rangos
		movKit = movKit + 0.5;
	if (movKit >= 128.5)
		movKit = movKit - 0.5;
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case ' ':		//reiniciar la variable
			movKit= 0; //reinicia el moviento del carro
			break;
